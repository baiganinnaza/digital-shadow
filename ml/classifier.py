...
PATTERNS: dict[str, dict] = {
    ...
    "нелицензионная_торговля": {
        "risk": "medium",
        "keywords": [
            "вейп опт", "жижа опт", "испаритель опт", "вейп оптом",
            "алкоголь оптом", "виски оптом", "водка оптом", "спирт оптом",
            "без документов", "без чека", "нал только", "нал принимаем",
            "доставка по всему казахстану", "доставка по казахстану",
            "анонимная доставка", "курьер анон", "нал доставка",
        ],
    },
}
